...
ActiveRecord::Schema.define(version: 20131223055923) do
  ...
  create_table "admin_user_tracings", force: true do |t|
  ...
  add_index "admin_user_tracings", ["admin_user_id"], name: "index_admin_user_tracings_on_admin_user_id", using: :btree
  ...
  add_index "admin_users", ["uid"], name: "index_admin_users_on_uid", unique: true, using: :btree
